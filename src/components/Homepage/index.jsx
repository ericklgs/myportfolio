    ...
    return(
        <MainContainer id="homePage">
            <Container >
                ...
                <ResumeBtn href="https://drive.google.com/file/d/1T2-fftuPXTz8To5jz6QW__QCqRtVvpTW/view?usp=sharing" target="_blank" rel="noopener noreferrer">Download CV</ResumeBtn>
            </Container>
        </MainContainer>
    )
};
